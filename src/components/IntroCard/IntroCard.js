...
const IntroCard = () => {
  return (
    <div className="container justify-between items-center flex lg:flex-row bg-gradient-to-r from-pink to-gradientEndPink text-white rounded-2xl w-full mb-8 px-4 py-5 gap-4 xl:gap-14 font-ubuntu flex-col">
